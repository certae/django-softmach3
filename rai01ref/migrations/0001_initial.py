    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('copyFrom', models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Artefact')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('outputArt', models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Artefact')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('info', jsonfield2.fields.JSONField(default={})),
                ('copyFrom', models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Capacity')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('smUUID', models.UUIDField(default=uuid.uuid4, editable=False)),
                ('code', models.CharField(max_length=200)),
                ('baseType', models.CharField(default='string', blank=True, null=True, max_length=50, choices=[('string', 'string'), ('text', 'text'), ('bool', 'bool'), ('int', 'int'), ('sequence', 'sequence'), ('decimal', 'decimal'), ('money', 'money'), ('combo', 'combo'), ('date', 'date'), ('datetime', 'datetime'), ('time', 'time')])),
                ('prpLength', models.IntegerField(blank=True, null=True)),
                ('prpScale', models.IntegerField(blank=True, null=True)),
                ('vType', models.CharField(default='string', blank=True, null=True, max_length=50, choices=[('string', 'string'), ('text', 'text'), ('bool', 'bool'), ('int', 'int'), ('sequence', 'sequence'), ('decimal', 'decimal'), ('money', 'money'), ('combo', 'combo'), ('date', 'date'), ('datetime', 'datetime'), ('time', 'time')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('info', jsonfield2.fields.JSONField(default={})),
                ('copyFrom', models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Requirement')),
                ('docType', models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.DocType')),
                ('refRequirement', models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Requirement')),
                ('smCreatedBy', models.ForeignKey(blank=True, editable=False, related_name='+', null=True, to=settings.AUTH_USER_MODEL)),
                ('smModifiedBy', models.ForeignKey(blank=True, editable=False, related_name='+', null=True, to=settings.AUTH_USER_MODEL)),
                ('smOwningTeam', models.ForeignKey(blank=True, editable=False, related_name='+', null=True, to='protoLib.TeamHierarchy')),
                ('smOwningUser', models.ForeignKey(blank=True, editable=False, related_name='+', null=True, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='capacity',
            name='docType',
            field=models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.DocType'),
        ),
        migrations.AddField(
            model_name='capacity',
            name='refCapacity',
            field=models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Capacity'),
        ),
        migrations.AddField(
            model_name='capacity',
            name='smCreatedBy',
        ...
        migrations.AddField(
            model_name='artefact',
            name='refArtefact',
            field=models.ForeignKey(blank=True, related_name='+', null=True, to='rai01ref.Artefact'),
        ),
        migrations.AddField(
            model_name='artefact',
            name='smCreatedBy',
