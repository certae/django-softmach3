...
def createContext():
    ...
    # protoExt_viewdefinition_1.metaDefinition = {
    #             'formConfig': {
    #                 'items': [{
    #                     'fsLayout': '2col',
    #                     'items': [{
    ...
    #             'gridConfig': {
    #                 'baseFilter': [],
    #                 'searchFields': ['smNaturalCode', 'smRegStatus', 'smWflowStatus', 'smInfo', 'code', 'description', 'notes', 'title', 'prefix'],
    #                 'filterSetABC': '',
    #                 'initialSort': [],
    #                 'sortFields': ['smNaturalCode', 'smRegStatus', 'smWflowStatus', 'smInfo', 'code', 'description', 'notes', 'title', 'prefix'],
    #                 'readOnlyFields': [],
    #                 'initialFilter': [],
    #                 'listDisplay': ['__str__'],
    ...
    #             }],
    #             'idProperty': 'id',
    #             'viewCode': 'prototype.Diagram',
    #             'actions': [{
    #                 'name': 'doDiagram',
    #                 'selectionMode': 'multiple'
    #             }],
    #             'shortTitle': 'Diagram',
    #             'viewEntity': 'prototype.Diagram',
    #             'viewIcon': 'icon-1',
    #             'detailsConfig': [{
    #                 'detailName': 'diagramentity.diagram',
    #                 'conceptDetail': 'prototype.DiagramEntity',
    #                 'detailField': 'diagram__pk',
    #                 'masterField': 'pk',
    #                 'menuText': 'Diagramentity.diagram'
    #             }],
    #             'exclude': []
    #         }
