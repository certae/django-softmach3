...
class ViewDefinitionAdmin(django.contrib.admin.ModelAdmin):
    protoExt = {
    "description": "proto Definition",
    "viewEntity": "protoLib.ViewDefinition",
    "viewIcon": "icon-1",
    "idProperty": "id",
    "viewCode": "protoLib.ViewDefinition",
    ...
    "fields": [{
        ...
        "name": "__str__",
        "fkId": "id",
        "zoomModel": "protoLib.ViewDefinition",
        "cellLink": True,
