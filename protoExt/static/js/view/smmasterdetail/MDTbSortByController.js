Ext.define('Softmachine.view.smmasterdetail.MDTbSortByController', {
    extend : 'Ext.Base',
    myMeta : null,
    ...
    getSortersBar : function(){
        ...
        // @formatter:off
        var me = this, mySortCols = [], __MasterDetail = me.__MasterDetail;
         ...
         * @param {Boolean}
         *            changeDirection True to change direction (default). Set to false for reorder
