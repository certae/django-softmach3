...
class JSONFieldTest(TestCase):
    ...
    def setUp(self):
        JsonModel.objects.create(code ="lion", info = { 'sound' : 'roar', 'name' : 'simba' } )
        JsonModel.objects.create(code ="cat", info = { 'sound' : 'meow' , 'name' : 'mambru' } )
        JsonModel.objects.create(code ="can", info = { 'sound' : 'guaf' , 'name' : 'mota' } )
        JsonModel.objects.create(code ="human", info = { 'sound' : 'bla', 'name' : 'toto' } )

    def test_json_field_create(self):
        """Test saving a JSON object in our JSONField"""
       
        new_obj = JsonModel.objects.get( code =  'lion' )
        self.assertEqual( new_obj.info, new_obj.info)
