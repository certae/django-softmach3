...
# from protoLib.utils.modelsTools import getNodeHierarchy
...
class ProtoModel(models.Model):
    ...
    smCreatedOn = models.DateTimeField( auto_now_add=True, editable=False)
    smModifiedOn = models.DateTimeField( auto_now=True, editable=False)

    smUUID = models.UUIDField( max_length=32, default=uuid.uuid4, editable=False)
